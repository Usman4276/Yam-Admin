...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    if (signupUser.role === "admin") {
      ...
      (signupUser.role === "brand" || signupUser.role === "bank") &&
      (signupUser.brandName || signupUser.bankName)
    ) {
      addDocToFirebase();
    } else {
  ...
  const addDocToFirebase = async () => {
    try {
      ...
      if (
        ...
        signupUser.role === "bank" ||
        signupUser.role === "brand"
      ) {
        ...
        const updateBrandData = {
          brandName: signupUser.brandName
            .toLowerCase()
            .replace(/\s+/g, "")
            .trim(),
        };
