...
function Bill({
  ...
  const [expireAlert, setExpireAlert] = React.useState(false);
  ...
  const expireAlertOpen = () => setExpireAlert(true);
  const expireAlertClose = () => setExpireAlert(false);
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            Are you sure you want to expire this sale?
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button onClick={expireAlertClose}>Cancel</Button>
          <Button
            sx={{ color: "error.main", "&:hover": { color: "error.main" } }}
            onClick={() => expireById()}
          >
        ...
        <DialogContent dividers>
          ...
          >
            ...
            <MDInput
              ...
              onKeyPress={(e) => {
                if (e.key === "Enter") {
                  setChipArray([...chipArray, e.target.value]);
                  setDbSalesData({
                    ...dbSalesData,
                    location: "",
                  });
            ...
            >
              ...
              <MDBox mr={1}>
                <MDButton
                  variant="text"
                  color="secondary"
                  onClick={expireAlertOpen}
                >
                  <RemoveCircleIcon>expire</RemoveCircleIcon>&nbsp;expire
                </MDButton>
              </MDBox>
              <MDBox mr={1}>
                <MDButton
