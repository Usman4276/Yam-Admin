...
function Bill({
  ...
  const [AllDayChecked, setAllDayChecked] = React.useState({
    checked: false,
    value: "",
  });
  ...
  React.useEffect(() => {
    let cards = discountCardData.map((items) => {
      return items.cards;
    });
  ...
  const onUpdateDiscountsData = async (e) => {
    ...
    const updateData = {
      ...
      discounts: arrayUnion(
        ...discountCardData.map((items) => {
          return items;
        })
      ),
  ...
  const handleChange = (event) => {
    ...
    const result = value.filter((item) => item === "All Days");
    if (result[0] === "All Days") {
      setPersonName(["All Days"]);
      !AllDayChecked.checked &&
        setAllDayChecked({
          checked: !AllDayChecked.checked,
          value: result[0],
        });
      return;
    } else {
  ...
  return (
    <>
                      ...
                      {locationTableData.map((items, index) => (
                        ...
                        >
                          ...
                          <TableCell component="th" scope="row" align="right">
                            <Button onClick={() => onDelLocationList(index)}>
                      ...
                      {discountCardData.map((items, index) => {
                        return (
                          ...
                          >
                            ...
                            <TableCell component="th" scope="row" align="right">
                              <Button
                                onClick={() => onDelDiscountsOnCardsList(index)}
                              >
                                <DeleteIcon color="error" />
                              </Button>
                            </TableCell>
      ...
      <MDBox
        ...
        mt={2}
      >
        <MDBox width="100%" display="flex" gap="1rem" flexDirection="column">
          <MDBox
            display="flex"
            justifyContent="space-between"
          ...
          <MDBox mb={0} lineHeight={0}>
            <MDTypography variant="caption" color="text">
              ...
              {days &&
                days.map((value) => {
                  return <Chip label={value} sx={{ margin: "0px 3px" }} />;
                })}
            </MDTypography>
          </MDBox>
          <MDBox
          ...
          >
            ...
            <MDAvatar
              sx={{ cursor: "pointer" }}
              onClick={discountImageModalOpen}
              src={discountImage}
              size="sm"
            />
          </MDBox>
