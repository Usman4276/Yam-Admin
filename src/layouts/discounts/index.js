...
function Discounts() {
  ...
  const [displayLocationButton, setDisplayLocationButton] =
  ...
  const fetchAllBanksAndBrands = async (selectedBank, selectedBrand) => {
    ...
    const dbBankData = getAllBanks.docs.map((items) => ({
      id: items.id,
      ...items.data(),
    }));
    ...
    const dbBrandData = getAllBrands.docs.map((items) => ({
      id: items.id,
      ...items.data(),
    }));
  ...
  const onAddDiscountsData = async (e) => {
    ...
    try {
      ...
      setPersonName([]);
      setAllDayChecked({ checked: false, value: "" });
    } catch (error) {
      setError(error.code);
      setLoading(false);
    }
          ...
          >
            ...
            <Paper elevation={5} sx={{ m: 2, borderRadius: "1rem", pb: 2 }}>
              <MDBox
                ...
                display="flex"
                justifyContent={
                  displayLocationButton === false ? "space-between" : "center"
                }
                alignItems="center"
              >
                ...
                {displayLocationButton === true ? null : (
                  <MDButton
                    variant="gradient"
                    color="light"
                    size="small"
                        ...
                        <TableBody>
                          {locationTableData.map((items, index) => (
                            ...
                            >
                              ...
                              >
                                <Button
                                  onClick={() => onDelLocationList(index)}
                                >
            ...
            <Paper elevation={5} sx={{ m: 2, borderRadius: "1rem", pb: 2 }}>
              <MDBox
                ...
                display="flex"
                justifyContent={
                  displayCardButton === false ? "space-between" : "center"
                }
                alignItems="center"
              >
                <MDTypography variant="h6" fontWeight="medium">
                          ...
                          {discountTableData.map((items, index) => (
                            ...
                            >
                              ...
                              >
                                <Button
                                  onClick={() =>
                                    onDelDiscountsOnCardsList(index)
                                  }
                                >
                                  <DeleteIcon color="error" />
                                </Button>
